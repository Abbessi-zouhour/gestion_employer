...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro"> Ajoouter ici un nouvel employer</div>
    </div>
...
<circle cx="8" cy="4.5" r="1"/>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-3" name="contact" placeholder="Entrer le contact" value="{{ old('contact') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="setting-input-3" name="montant_journalier" value="{{ old('montant_journalier') }}" placeholder="Entrer le montant à journalier">
