...
<div class="row g-4 settings-section">
    <div class="col-12 col-md-4">
        ...
        <div class="section-intro"> Ajoouter ici une nouvelle configurations</div>
    </div>
...
<circle cx="8" cy="4.5" r="1"/>
                        ...
                        <select name="type" id="type" class="form-control">
                            ...
                            <option value="APP_NAME">Nom de Lapplication</option>
                            <option value="DEVELOPPER_NAME">Equipe de dévéloppement</option>
