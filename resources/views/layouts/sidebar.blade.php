        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html">
                ...
                {{  AppNameGetter::getAppName() ??
                    AppNameGetter::getAppName() ?? 'Gestion' }}"
        ...
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-admin" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('administrateurs') }}">Liste</a></li>
                            <li class="submenu-item"><a class="submenu-link" href="{{ route('administrateurs.create') }}">Ajout</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-departement" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-employer" class="collapse submenu submenu-2" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
