                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    ...
                                    href="{{ route('employer.edit', $admin->id)}}">Editer
                                    </a>
                                    <a
                                    class="btn-sm app-btn-secondary" href="{{ route('employer.delete', $admin->id)}}">Supprimer
                                    </a>
                                </td>
                            </tr>
                            ...
                            @empty
                            <tr>
                                <td class="cell" colspan="6">Aucun employeurs ajoutés</td>
                            </tr>
                            @endforelse
