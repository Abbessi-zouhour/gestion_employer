...
<circle cx="8" cy="4.5" r="1"/>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control" id="setting-input-3" name="email" placeholder="Entrer le mail" value="{{$employer->email}}">
                        @error('email')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="setting-input-3" name="contact" placeholder="Entrer le contact" value="{{$employer->contact}}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="setting-input-3" name="montant_journalier" value="{{$employer->montant_journalier}}" placeholder="Entrer le montant à journalier">
